...
> This repository is mainly used for project presentation and usage information. Compatible with iPhone and iPad (iOS 17.0+), as well as Apple Silicon Macs (macOS 14.0+). The Liquid Glass effect requires iOS 26.0+ or macOS 26.0+.
